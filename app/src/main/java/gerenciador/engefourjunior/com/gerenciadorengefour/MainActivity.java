...
public class MainActivity extends AppCompatActivity {
    ...
    protected  void CarregaOpcoesLista(){
        ...
        itens[4] = "Cadastrar  Nova Venda";
        itens[5] = "Consultar Vendas";
    ...
    protected void RedirecionaTela(String opcaoMenu){
        ...
        else if(opcaoMenu.equals("Cadastrar  Nova Venda")) {
            intentRedirecionar = new Intent(this, CadastrarVendaActivity.class);
            startActivity(intentRedirecionar);
            finish();
        }
        else if(opcaoMenu.equals("Consultar Vendas")) {
            intentRedirecionar = new Intent(this, ConsultarVendaActivity.class);
            startActivity(intentRedirecionar);
            finish();
        }
